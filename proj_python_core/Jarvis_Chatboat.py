...
if __name__=="__main__":
    while True:
        ...
        if "time" in str.lower(audio):
            ...
            print(songs)
            print(songs[10])
            speak("opening Music from local folder")
            ...
            # audio = takeCommand()
                ...
                webbrowser.open("C:\\Users\\pradeep\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Accessories\\Notepad")
        elif "news" in str.lower(audio):
