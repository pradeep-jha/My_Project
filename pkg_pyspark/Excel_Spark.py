...
spark=SparkSession.builder.master("local[*]") \
                                .appName("Excle_Spark") \
                                 .getOrCreate()
in_df=pd.read_excel("C:\\Users\\pradeep\\Desktop\\pycharm_spark\\input\\911-2.xlsx",sheet_name='Sheet3',converters={'Date': str})
...
schema = StructType([StructField("lat", DoubleType(), True), StructField("lng", DoubleType(), True),StructField("desc", StringType(), True) \
