...
inp = spark.read.format('csv').options(header=True, inferSchema=True).option("delimiter", ",").load("C:\\Users\\PRADEEP\\PycharmProjects\\My_Project\\pySparkProject\\inputs\\data.csv")
